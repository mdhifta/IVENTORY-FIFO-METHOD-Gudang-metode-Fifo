                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-first-name" name="nama" class="form-control" value="<?= $kariyawan->nama_kariyawan; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="number" id="input-first-name" name="kontak" class="form-control" value="<?= $kariyawan->kontak; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-first-name" name="username" class="form-control" value="<?= $kariyawan->username; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="password" id="input-first-name" name="password" class="form-control" value="<?= $kariyawan->password; ?>">
                    </div>
                  </div>
                </div>
              </div>
