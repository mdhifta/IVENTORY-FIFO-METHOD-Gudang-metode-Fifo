              ...
              <?php foreach($_SESSION['id_barang'] as $row => $id_barang): ?>
                ...
                <tr>
                  ...
                  <td style="font-size:20px;"><?= $_SESSION['jumlah'][$row]; ?>&nbsp; &nbsp;&nbsp;
                    <a class="btn btn-danger" href="backend/hapuskeranjang.php?id=<?= $row; ?>">-</a>
                    <a class="btn btn-primary" href="backend/keranjang.php?id=<?= $id_barang; ?>&row=<?= $row; ?>">+</a>
                  </td>
                  <td style="font-size:20px;">Rp. <?= number_format($_SESSION['harga'][$row]); ?>,-</td>
