                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="input-username" readonly value="<?= $data->nama_brg; ?>">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nama Supplier</label>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="number" id="input-first-name" name="jumlah" class="form-control" value="<?= $data->jumlah_beli; ?>">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Harga Barang</label>
                          <input type="number" id="input-first-name" name="harga" class="form-control" value="<?= $data->harga; ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pl-lg-4">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Jumlah Barang</label>
                          <input type="number" id="input-first-name" name="jumlah" class="form-control" placeholder="Jumlah Barang" required>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Harga Barang</label>
                          <input type="number" id="input-first-name" name="harga" class="form-control" placeholder="Harga Barang/ (Pcs/Kg)" required>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <?php foreach($_SESSION['id_barang'] as $num_array => $id_barang): ?>
                    ...
                    <tr>
                      ...
                      <td style="font-size:20px;"><?= $_SESSION['jumlah'][$num_array]; ?>&nbsp; &nbsp;&nbsp;
                        <a class="btn btn-danger" href="backend/hapuskeranjang.php?id=<?= $num_array; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        <a class="btn btn-primary" href="backend/keranjang.php?id=<?= $num_array; ?>"><i class="fa fa-plus" aria-hidden="true"></i></a>
                      </td>
                      <td>Rp. <?= number_format($_SESSION['harga'][$num_array]); ?>,-</td>
                      <td>Rp. <?= number_format($_SESSION['harga'][$num_array]*$_SESSION['jumlah'][$num_array]); ?>,-</td>
                    </tr>
                  <?php endforeach; ?>
                <?php endif; ?>
              </tbody>
