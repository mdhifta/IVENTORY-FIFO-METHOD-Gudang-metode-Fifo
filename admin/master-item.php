        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              ...
              <a href="../laporan/laporanBarang.php" target="_blank" class="btn btn-sm btn-primary">cetak Laporan</a>
                  ...
                  while ($barang = $query->fetch_object()) { ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="add-item.php?id=<?= $barang->id_barang; ?>" class="btn btn-sm btn-info">Ubah</a>
                      </td>
                    </td>
                  </tr>
                  <?php
