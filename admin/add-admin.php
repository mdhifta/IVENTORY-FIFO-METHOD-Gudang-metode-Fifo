                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-username" name="nadmin" class="form-control" value="<?= $data->nama_admin; ?>">
                        </div>
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Email</label>
                          <input type="email" id="input-username" name="email" class="form-control" value="<?= $data->email; ?>">
                        </div>
                        <?php
                        if ($admin->level==1) {
                          echo '
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-first-name" name="username" class="form-control" value="<?= $data->username; ?>">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Telephone/Kontak</label>
                          <input type="number" id="input-first-name" name="telp" class="form-control" value="<?= $data->no_handphone; ?>">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                  ...
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nama Admin</label>
                          <input type="text" id="input-username" name="nadmin" class="form-control" placeholder="Nama Admin" required>
                        </div>
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Email</label>
                          <input type="email" id="input-username" name="email" class="form-control" placeholder="Email" required>
                        </div>
                        <?php
                        if ($admin->level==1) {
                          echo '
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Username</label>
                          <input type="text" id="input-first-name" name="username" class="form-control" placeholder="username" required>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Telephone/Kontak</label>
                          <input type="number" id="input-first-name" name="telp" class="form-control" placeholder="Telephone/Kontak">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
