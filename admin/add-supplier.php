                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-username" name="nsupplier" class="form-control" value="<?= $supplier->nama_supplier; ?>">
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Alamat</label>
                          <input type="text" id="input-email" name="alamat" class="form-control" value="<?= $supplier->alamat_supplier; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="number" id="input-first-name" name="kontak" class="form-control" value="<?= $supplier->kontak_supplier; ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nama Supplier</label>
                          <input type="text" id="input-username" name="nsupplier" class="form-control" placeholder="Nama Barang" required>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Alamat</label>
                          <input type="text" id="input-email" name="alamat" class="form-control" placeholder="Alamat Supplier" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Nomor Handphone</label>
                          <input type="number" id="input-first-name" name="kontak" class="form-control" placeholder="Nomor Handphone Supplier" required>
                        </div>
                      </div>
                    </div>
                  </div>
