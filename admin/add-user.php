                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nama Kariyawan</label>
                          <input type="text" id="input-username" name="nkariyawan" class="form-control" value="<?= $data->nama_kariyawan; ?>">
                        </div>
                      </div>
                      <input type="hidden" name="id" value="<?= $data->id_kariyawan; ?>">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Kontak/No Handphone</label>
                          <input type="number" id="input-email" name="kontak" class="form-control" value="<?= $data->kontak; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                  ...
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nama Kariyawan</label>
                          <input type="text" id="input-username" name="nkariyawan" class="form-control" placeholder="Nama Kariyawan" required>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Kontak/No Handphone</label>
                          <input type="number" id="input-email" name="kontak" class="form-control" placeholder="Nomor Handphone" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
