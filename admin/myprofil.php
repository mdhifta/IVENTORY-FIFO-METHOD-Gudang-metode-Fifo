                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-first-name" name="nama" class="form-control" value="<?= $admin->nama_admin; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="input-first-name" name="username" class="form-control" value="<?= $admin->username; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="password" id="input-first-name" name="password" class="form-control" value="<?= $admin->password; ?>">
                    </div>
                  </div>
                </div>
              </div>
