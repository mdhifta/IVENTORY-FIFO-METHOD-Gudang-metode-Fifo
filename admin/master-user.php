              ...
              <tbody>
                ...
                while ($kariyawan = $data->fetch_object()) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="../backend/delete-kariyawan.php?id=<?= $kariyawan->id_kariyawan; ?>" class="btn btn-sm btn-danger">Hapus</a>
                      <a href="add-user.php?id=<?= $kariyawan->id_kariyawan; ?>" class="btn btn-sm btn-info">Ubah</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
