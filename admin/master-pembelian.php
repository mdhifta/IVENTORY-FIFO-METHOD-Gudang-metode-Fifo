            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col-lg-10 col-5 text-right">
                  <form class="" action="../laporan/laporanPembelian.php" target="_blank" method="post">
                ...
                <tbody>
                  ...
                  while ($barang = $data->fetch_object()) {
                    ...
                    <tr>
                      ...
                      <!-- <?php if ($barang->history==0): ?>
                        <td>
                          <a href="../backend/delete-pembelian.php?id=<?= $barang->id_barang_msk; ?>" class="btn btn-sm btn-danger">Hapus</a>
                          <a href="add-pembelian.php?id=<?= $barang->id_barang_msk; ?>" class="btn btn-sm btn-info">Ubah</a>
                        </td>
                      <?php else: ?>
                        <td>
                          <span>SUDAH DILAKUKAN TRANSAKSI</span>
                        </td>
                      <?php endif; ?> -->
                    </tr>
                  <?php } ?>
