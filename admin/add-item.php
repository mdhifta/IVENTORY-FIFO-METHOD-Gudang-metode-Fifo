                ...
                <form action="../backend/change-items.php" method="post">
                  ...
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-username" name="nbarang" class="form-control" value="<?= $barang->nama_brg; ?>">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">Harga Jual</label>
                          <input type="number" readonly id="input-first-name" name="hjual" class="form-control" value="<?= $barang->harga_jual; ?>">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Jumlah</label>
                          <input type="number" readonly id="input-email" name="jumlah" class="form-control" value="<?= $barang->jumlah; ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nama Barang</label>
                          <input type="text" id="input-username" name="nbarang" class="form-control" placeholder="Nama Barang" required>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <!-- <label class="form-control-label" for="input-first-name">Harga Jual</label> -->
                          <input type="hidden" readonly id="input-first-name" name="hjual" class="form-control" value="0">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <!-- <label class="form-control-label" for="input-email">Jumlah</label> -->
                          <input type="hidden" readonly id="input-email" name="jumlah" class="form-control" value="0">
                        </div>
                      </div>
                    </div>
                  </div>
